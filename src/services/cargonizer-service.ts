...
// 	constructor($api_key, $sender_id, $transport_agreement, $url = '') {
...
// 	public requestConsignment($wc_order, $wc_order_weight,	 $debug=0) {
// 		this.pkg_number = "0";
// 		this.urls = Array<any>();
...
// 		let servicePartnerResponse = this.requestServicePartners('NO', $wc_order.get_shipping_postcode());
